...
(use-package lsp-bridge
  :after yasnippet
  :ensure (:host github :repo "manateelazycat/lsp-bridge" :files ("acm" "core" "langserver" "multiserver" "test" "*.py" "*.el"))
:bind
  ;; Привязки для нормального режима Meow
...
#+RESULTS:
: [nil 26458 63226 185879 nil elpaca-process-queues nil nil 0 nil]
